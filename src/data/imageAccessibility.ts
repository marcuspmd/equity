...
> = {
  "ada-lovelace": {
    ...
    altText: "Portrait of Ada Lovelace, English mathematician and first computer programmer, wearing Victorian-era dress and looking directly at the viewer",
  ...
  "mary-somerville": {
    ...
    category: "The Pioneers",
    altText: "Portrait of Mary Somerville, Scottish polymath and scientist, in formal attire demonstrating her scholarly presence and intellectual authority",
  ...
  "edith-clarke": {
    ...
    name: "Edith Clarke",
    category: "The Pioneers",
    altText: "Portrait of Edith Clarke, American electrical engineer and inventor, pioneering woman in electrical power systems engineering",
  ...
  "grete-hermann": {
    ...
    name: "Grete Hermann",
    category: "The Pioneers",
    altText: "Portrait of Grete Hermann, German mathematician and philosopher, whose work contributed to quantum mechanics and early computer science",
  ...
  "mary-cartwright": {
    ...
    category: "The Pioneers",
    altText: "Portrait of Mary Cartwright, British mathematician whose work laid the foundations for chaos theory",
  ...
  "rozsa-peter": {
    ...
    name: "Rózsa Péter",
    category: "The Pioneers",
    altText: "Portrait of Rózsa Péter, Hungarian mathematician and logician, pioneering researcher in recursive function theory and recreational mathematics",
  ...
  "hedy-lamarr": {
    ...
    name: "Hedy Lamarr",
    category: "The Pioneers",
    altText: "Portrait of Hedy Lamarr, Austrian-American actress and inventor whose frequency-hopping technology laid the groundwork for modern Wi-Fi and Bluetooth",
  ...
  "grace-hopper": {
    ...
    name: "Grace Hopper",
    category: "The Pioneers",
    altText: "Grace Hopper, American computer scientist and US Navy admiral, COBOL developer",
  ...
  "mary-kenneth-keller": {
    ...
    category: "The Pioneers",
    altText: "Portrait of Mary Kenneth Keller, American mathematician and educator, first woman to earn PhD in Computer Science and instrumental in developing BASIC",
    title: "First CS PhD",
    ariaDescription:
  ...
  "beatrice-worsley": {
    ...
    category: "The Pioneers",
    altText: "Portrait of Beatrice Worsley, Canadian computer scientist, one of the first people to program early computers and first female computer scientist in Canada",
  ...
  "kateryna-yushchenko": {
    ...
    category: "The Pioneers",
    altText: "Portrait of Kateryna Yushchenko, Ukrainian computer scientist and creator of Address programming language, first woman Doctor of Physical and Mathematical Sciences in USSR",
  ...
  "thelma-estrin": {
    ...
    name: "Thelma Estrin",
    category: "The Pioneers",
    altText: "Thelma Estrin, American computer scientist, biomedical engineering pioneer",
  ...
  "evelyn-boyd-granville": {
    ...
    category: "The Pioneers",
    altText: "Evelyn Boyd Granville, African-American mathematician, space age computing pioneer",
  ...
  "ida-rhodes": {
    ...
    name: "Ida Rhodes",
    category: "The Pioneers",
    altText: "Portrait of Ida Rhodes, American mathematician who pioneered early computer language translation and designed the C-10 programming language for UNIVAC",
  ...
  "kathleen-booth": {
    ...
    name: "Kathleen Booth",
    category: "The Pioneers",
    altText: "Kathleen Booth, British computer scientist, inventor of assembly language",
  ...
  "klara-dan-von-neumann": {
    ...
    category: "The Pioneers",
    altText: "Klára Dán von Neumann, Hungarian-American computer scientist, early ENIAC programmer",
  ...
  "joan-clarke": {
    ...
    name: "Joan Clarke",
    category: "The Pioneers",
    altText: "Joan Clarke, English cryptanalyst, Enigma code breaker at Bletchley Park",
  ...
  "margaret-rock": {
    ...
    name: "Margaret Rock",
    category: "The Pioneers",
    altText: "Portrait of Margaret Rock, British mathematician and codebreaker who worked at Bletchley Park and helped decrypt the German Enigma cipher",
  ...
  "mavis-batey": {
    ...
    name: "Mavis Batey",
    category: "The Pioneers",
    altText: "Portrait of Mavis Batey, British codebreaker who broke the Italian naval Enigma code at Bletchley Park during World War II",
  ...
  "dorothy-du-boisson": {
    ...
    category: "The Pioneers",
    altText: "Portrait of Dorothy Du Boisson, Colossus computer operator at Bletchley Park who helped decrypt Lorenz ciphers during World War II",
  ...
  "jean-bartik": {
    ...
    altText: "Portrait of Jean Bartik, American computer programmer and one of the original ENIAC programmers who invented fundamental programming methods",
    title: "ENIAC Pioneer",
    ariaDescription:
  ...
  "betty-holberton": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Betty Holberton, American computer programmer and one of the original ENIAC programmers who developed fundamental programming techniques",
  ...
  "frances-spence": {
    ...
    name: "Frances Spence",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Frances Spence, American computer programmer and one of the first ENIAC programmers who developed fundamental programming techniques",
  ...
  "ruth-teitelbaum": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Ruth Teitelbaum, American mathematician and one of the first ENIAC programmers who helped program the first electronic computer",
  ...
  "marlyn-meltzer": {
    ...
    name: "Marlyn Meltzer",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Marlyn Meltzer, American computer programmer who programmed ENIAC and helped demonstrate the world's first electronic computer",
    title: "ENIAC Programmer",
    ariaDescription:
  ...
  "kathleen-antonelli": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Kathleen Antonelli, American computer programmer and one of the first ENIAC operators who became programming director at Remington Rand",
    title: "ENIAC Programmer",
    ariaDescription:
  ...
  "adele-goldstine": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Adele Goldstine, American mathematician who programmed EDVAC and wrote the first comprehensive technical documentation on programming",
  ...
  "gloria-gordon-bolotsky": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Gloria Gordon Bolotsky, American computer programmer and one of the original ENIAC programmers who helped program the first electronic computer",
    title: "ENIAC Programmer",
    ariaDescription:
  ...
  "ester-gerston": {
    ...
    name: "Ester Gerston",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Ester Gerston, American computer programmer and one of the ENIAC programmers who developed foundational programming methods",
    title: "ENIAC Programmer",
    ariaDescription:
  ...
  "ruth-briggs": {
    ...
    name: "Ruth Briggs",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Ruth Briggs, American mathematician and one of the original ENIAC operators and programmers who contributed to early computing development",
    title: "ENIAC Mathematician",
    ariaDescription:
  ...
  "agnes-meyer-driscoll": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Agnes Meyer Driscoll, American cryptanalyst and security pioneer who broke naval codes and contributed to US military intelligence",
  ...
  "genevieve-grotjan-feinstein": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Genevieve Grotjan Feinstein, American cryptanalyst whose insights were instrumental to breaking the Enigma cipher during World War II",
  ...
  "elizebeth-smith-friedman": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Elizebeth Smith Friedman, American codebreaker, cryptanalyst, World War I and II",
  ...
  "ann-mitchell": {
    ...
    name: "Ann Mitchell",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Ann Mitchell, British codebreaker who worked at Bletchley Park during World War II contributing to breaking Enigma codes",
    title: "Bletchley Park Cryptanalyst",
    ariaDescription:
  ...
  "sarah-baring": {
    ...
    name: "Sarah Baring",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Sarah Baring, British codebreaker and operator who worked at Bletchley Park during World War II",
  ...
  "jane-hughes": {
    ...
    name: "Jane Hughes",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Jane Hughes, British cryptanalyst who worked at Bletchley Park during World War II contributing to code-breaking efforts",
    title: "Bletchley Park Cryptanalyst",
    ariaDescription:
  ...
  "krystyna-skarbek": {
    ...
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Krystyna Skarbek, Polish spy and intelligence operative who worked with British intelligence during World War II resistance efforts",
  ...
  "virginia-hall": {
    ...
    name: "Virginia Hall",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Virginia Hall, American spy and intelligence analyst who worked for the US government during World War II and the Cold War, becoming one of the first female CIA officers",
  ...
  "aileen-clarke": {
    ...
    name: "Aileen Clarke",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Aileen Clarke, British codebreaker who worked at Bletchley Park contributing to breaking enemy codes during World War II",
    title: "Bletchley Park Cryptanalyst",
    ariaDescription:
  ...
  "mary-gray": {
    ...
    name: "Mary Gray",
    category: "Early Coders & Cryptographers",
    altText: "Portrait of Mary Gray, American mathematician and operations researcher who pioneered the use of mathematics and computers in solving real-world scientific problems",
  ...
  "dorothy-vaughan": {
    ...
    altText: "Portrait of Dorothy Vaughan, African-American mathematician and NASA computing supervisor, pioneering figure in the space program featured in Hidden Figures",
  ...
  "mary-jackson": {
    ...
    name: "Mary Jackson",
    category: "Space & Apollo",
    altText: "Portrait of Mary Jackson, African-American mathematician and engineer at NASA who overcame significant barriers to become a respected space program engineer",
    title: "NASA Engineer",
    ariaDescription:
  ...
  "katherine-johnson": {
    ...
    category: "Space & Apollo",
    altText: "Portrait of Katherine Johnson, African-American mathematician whose precise calculations were critical to NASA Mercury and Apollo spaceflights",
  ...
  "margaret-hamilton": {
    ...
    category: "Space & Apollo",
    altText: "Portrait of Margaret Hamilton, American systems engineer who directed Apollo program software development and coined the term software engineering",
  ...
  "christine-darden": {
    ...
    category: "Space & Apollo",
    altText: "Portrait of Christine Darden, African-American aerospace engineer at NASA pioneering aeronautical research and supersonic flight technology",
  ...
  "annie-easley": {
    ...
    name: "Annie Easley",
    category: "Space & Apollo",
    altText: "Portrait of Annie Easley, African-American mathematician and computer programmer at NASA who worked on battery technology research for the space program",
  ...
  "melba-roy-mouton": {
    ...
    category: "Space & Apollo",
    altText: "Portrait of Melba Roy Mouton, African-American mathematician who supervised trajectory analysis at NASA and contributed to the space program",
  ...
  "valerie-thomas": {
    ...
    name: "Valerie Thomas",
    category: "Space & Apollo",
    altText: "Portrait of Valerie Thomas, African-American inventor and NASA engineer who pioneered 3D imaging technology including the illusion transmitter",
  ...
  "sally-ride": {
    ...
    name: "Sally Ride",
    category: "Space & Apollo",
    altText: "Portrait of Sally Ride, American astronaut and physicist, first American woman to fly in space and strong advocate for science education",
  ...
  "mae-jemison": {
    ...
    name: "Mae Jemison",
    category: "Space & Apollo",
    altText: "Portrait of Mae Jemison, African-American astronaut, physician and space scientist who became the first African-American woman to travel in space",
  ...
  "ellen-ochoa": {
    ...
    name: "Ellen Ochoa",
    category: "Space & Apollo",
    altText: "Portrait of Ellen Ochoa, Hispanic-American astronaut and optical physicist who became the first Latina to fly in space and served as NASA director",
  ...
  "kalpana-chawla": {
    ...
    name: "Kalpana Chawla",
    category: "Space & Apollo",
    altText: "Portrait of Kalpana Chawla, Indian-American astronaut and space shuttle commander dedicated to space exploration",
  ...
  "peggy-whitson": {
    ...
    name: "Peggy Whitson",
    category: "Space & Apollo",
    altText: "Portrait of Peggy Whitson, American astronaut who holds the record for most time spent in space and has served as International Space Station commander",
  ...
  "eileen-collins": {
    ...
    name: "Eileen Collins",
    category: "Space & Apollo",
    altText: "Portrait of Eileen Collins, American astronaut and pilot who became the first female space shuttle commander",
  ...
  "nancy-grace-roman": {
    ...
    category: "Space & Apollo",
    altText: "Portrait of Nancy Grace Roman, American astronomer who directed the Hubble Space Telescope program, known as the Mother of Hubble",
  ...
  "joann-morgan": {
    ...
    name: "JoAnn Morgan",
    category: "Space & Apollo",
    altText: "Portrait of JoAnn Morgan, American engineer and NASA Apollo launch director who worked on some of history's most significant space missions",
  ...
  "poppy-northcutt": {
    ...
    category: "Space & Apollo",
    altText: "Portrait of Poppy Northcutt, American engineer who designed the abort control systems for the Apollo spacecraft and worked in NASA mission control",
  ...
  "judy-sullivan": {
    ...
    name: "Judy Sullivan",
    category: "Space & Apollo",
    altText: "Portrait of Judy Sullivan, American control systems engineer who worked in NASA's mission control center contributing to space mission success",
  ...
  "eula-bingham": {
    ...
    name: "Eula Bingham",
    category: "Space & Apollo",
    altText: "Portrait of Eula Bingham, American occupational health researcher who worked on safety issues for NASA and other organizations",
  ...
  "dottie-metcalf-lindenburger": {
    ...
    category: "Space & Apollo",
    altText: "Portrait of Dorothy Metcalf-Lindenburger, American astronaut and geologist who became the first teacher to conduct lessons from space",
  ...
  "evelyn-berezin": {
    ...
    altText: "Evelyn Berezin, American computer scientist, word processor inventor",
  ...
  "carol-shaw": {
    ...
    name: "Carol Shaw",
    category: "Modern Innovators",
    altText: "Portrait of Carol Shaw, American computer programmer and video game designer, one of the first female video game designers",
  ...
  "adele-goldberg": {
    ...
    name: "Adele Goldberg",
    category: "Modern Innovators",
    altText: "Portrait of Adele Goldberg, American computer scientist instrumental in developing Smalltalk and pioneering graphical user interfaces",
  ...
  "radia-perlman": {
    ...
    name: "Radia Perlman",
    category: "Modern Innovators",
    altText: "Portrait of Radia Perlman, American computer scientist who invented the spanning tree protocol and is known as the mother of the internet",
  ...
  "lynn-conway": {
    ...
    name: "Lynn Conway",
    category: "Modern Innovators",
    altText: "Portrait of Lynn Conway, American computer scientist and pioneer in VLSI chip design who revolutionized modern computing",
  ...
  "sophie-wilson": {
    ...
    name: "Sophie Wilson",
    category: "Modern Innovators",
    altText: "Portrait of Sophie Wilson, British computer scientist who designed the ARM processor instruction set fundamental to modern mobile computing",
  ...
  "roberta-williams": {
    ...
    category: "Modern Innovators",
    altText: "Portrait of Roberta Williams, American video game designer and co-founder of Sierra Entertainment who pioneered adventure games",
  ...
  "donna-dubinsky": {
    ...
    name: "Donna Dubinsky",
    category: "Modern Innovators",
    altText: "Portrait of Donna Dubinsky, American entrepreneur who co-founded Palm Computing and led development of the Palm Pilot",
  ...
  "susan-kare": {
    ...
    name: "Susan Kare",
    category: "Modern Innovators",
    altText: "Portrait of Susan Kare, American graphic designer who designed icons and fonts for Apple Macintosh and Windows, influencing computing aesthetics",
  ...
  "stacy-horn": {
    ...
    name: "Stacy Horn",
    category: "Modern Innovators",
    altText: "Portrait of Stacy Horn, American entrepreneur who founded ECHO, one of the first online communities and early internet pioneers",
  ...
  "elizabeth-feinler": {
    ...
    category: "Modern Innovators",
    altText: "Portrait of Elizabeth Feinler, American computer scientist who created and managed the ARPANET directory, revolutionizing early internet communication",
  ...
  "sandy-lerner": {
    ...
    name: "Sandy Lerner",
    category: "Modern Innovators",
    altText: "Portrait of Sandy Lerner, American entrepreneur and Cisco Systems co-founder who developed router technology fundamental to modern internet infrastructure",
  ...
  "mitchell-baker": {
    ...
    name: "Mitchell Baker",
    category: "Modern Innovators",
    altText: "Portrait of Mitchell Baker, American technologist and CEO of Mozilla advancing open-source internet technology and web freedom",
  ...
  "marissa-mayer": {
    ...
    name: "Marissa Mayer",
    category: "Modern Innovators",
    altText: "Portrait of Marissa Mayer, American computer scientist and former Yahoo CEO, influential in tech industry leadership and product development",
  ...
  "sheryl-sandberg": {
    ...
    category: "Modern Innovators",
    altText: "Portrait of Sheryl Sandberg, American technology executive and Chief Operating Officer of Meta, advocate for women in business leadership",
  ...
  "susan-wojcicki": {
    ...
    name: "Susan Wojcicki",
    category: "Modern Innovators",
    altText: "Portrait of Susan Wojcicki, American technology executive who served as CEO of YouTube, instrumental in shaping video sharing technology",
    title: "YouTube CEO",
    ariaDescription:
  ...
  "meg-whitman": {
    ...
    name: "Meg Whitman",
    category: "Modern Innovators",
    altText: "Portrait of Meg Whitman, American business executive who was CEO of eBay during its critical growth phase in e-commerce",
    title: "eBay CEO",
    ariaDescription:
  ...
  "safra-catz": {
    ...
    name: "Safra Catz",
    category: "Modern Innovators",
    altText: "Portrait of Safra Catz, Israeli-American technology executive and co-president of Oracle, pioneering female technology leaderresident of Oracle, pioneering female technology leader",
  ...
  "ginni-rometty": {
    ...
    name: "Ginni Rometty",
    category: "Modern Innovators",
    altText: "Portrait of Ginni Rometty, American business leader who served as CEO of IBM guiding the company through digital transformation",
    title: "IBM CEO",
    ariaDescription:
  ...
  "ursula-burns": {
    ...
    name: "Ursula Burns",
    category: "Modern Innovators",
    altText: "Portrait of Ursula Burns, American engineer who became the first African-American female CEO of a Fortune 500 company",
    title: "Xerox CEO",
    ariaDescription:
  ...
  "joy-buolamwini": {
    ...
    altText: "Portrait of Joy Buolamwini, Ghanaian-American computer scientist and digital activist researching algorithmic bias in facial recognition technology",
  ...
  "timnit-gebru": {
    ...
    name: "Timnit Gebru",
    category: "Algorithmic Justice",
    altText: "Portrait of Timnit Gebru, Ethiopian-American computer scientist researching artificial intelligence bias and ethics, founder of Distributed AI Research Institute",
  ...
  "safiya-noble": {
    ...
    name: "Safiya Noble",
    category: "Algorithmic Justice",
    altText: "Portrait of Safiya Noble, American scholar researching race, gender, technology and algorithmic inequality, author of Algorithms of Oppression",
  ...
  "ruha-benjamin": {
    ...
    name: "Ruha Benjamin",
    category: "Algorithmic Justice",
    altText: "Portrait of Ruha Benjamin, American sociologist researching race, inequality and technology, director of the Center on Inequality and Technology",
  ...
  "cathy-oneil": {
    ...
    name: "Cathy O'Neill",
    category: "Algorithmic Justice",
    altText: "Portrait of Cathy O'Neill, American mathematician and author of Weapons of Math Destruction, advocating for accountability in algorithmic systems",
  ...
  "latanya-sweeney": {
    ...
    category: "Algorithmic Justice",
    altText: "Portrait of Latanya Sweeney, American computer scientist researching privacy, discrimination and algorithmic fairness in technology",
  ...
  "meredith-broussard": {
    ...
    category: "Algorithmic Justice",
    altText: "Portrait of Meredith Broussard, American journalist and researcher examining limits of technology and advocating for critical AI examination",
  ...
  "virginia-eubanks": {
    ...
    category: "Algorithmic Justice",
    altText: "Portrait of Virginia Eubanks, American scholar researching surveillance technology and digital systems affecting marginalized communities",
  ...
  "kate-crawford": {
    ...
    name: "Kate Crawford",
    category: "Algorithmic Justice",
    altText: "Portrait of Kate Crawford, Australian-American researcher studying artificial intelligence and its relationship to power and justice",
  ...
  "margaret-mitchell": {
    ...
    category: "Algorithmic Justice",
    altText: "Portrait of Margaret Mitchell, American computer scientist researching AI safety and advocating for ethical AI development",
  ...
  "rumman-chowdhury": {
    ...
    category: "Algorithmic Justice",
    altText: "Portrait of Rumman Chowdhury, Bangladeshi-American technologist studying social media algorithms and advocating for algorithmic transparency",
  ...
  "rediet-abebe": {
    ...
    name: "Rediet Abebe",
    category: "Algorithmic Justice",
    altText: "Portrait of Rediet Abebe, Ethiopian computer scientist researching algorithms and inequality, co-founder of Black in AI",
  ...
  "inioluwa-deborah-raji": {
    ...
    name: "Deborah Raji",
    category: "Algorithmic Justice",
    altText: "Portrait of Deborah Raji, Nigerian-American researcher investigating bias in AI systems particularly facial recognition technology",
  ...
  "sasha-costanza-chock": {
    ...
    category: "Algorithmic Justice",
    altText: "Portrait of Sasha Costanza-Chock, American technology and media justice researcher and author of Design Justice",
  ...
  "mutale-nkonde": {
    ...
    name: "Mutale Nkonde",
    category: "Algorithmic Justice",
    altText: "Portrait of Mutale Nkonde, Zambian social technology researcher critiquing facial recognition and surveillance technologies",
  ...
  "yeshimabeit-milner": {
    ...
    category: "Algorithmic Justice",
    altText: "Portrait of Yeshimabeit Milner, American technologist and founder of Algorithmic Justice League challenging algorithmic oppression",
  ...
  "sarah-myers-west": {
    ...
    category: "Algorithmic Justice",
    altText: "Portrait of Sarah Myers West, American researcher and co-founder of AI Now Institute researching social implications of AI",
  ...
  "alex-hanna": {
    ...
    name: "Alex Hanna",
    category: "Algorithmic Justice",
    altText: "Portrait of Alex Hanna, American machine learning researcher focused on algorithmic fairness and social implications of AI",
  ...
  "emily-m-bender": {
    ...
    name: "Emily M. Bender",
    category: "Algorithmic Justice",
    altText: "Portrait of Emily M. Bender, American computer scientist and linguist researching social implications of large language models",
  ...
  "cynthia-dwork": {
    ...
    name: "Cynthia Dwork",
    category: "Algorithmic Justice",
    altText: "Portrait of Cynthia Dwork, American computer scientist who invented differential privacy to protect individual privacy in data analysis",
