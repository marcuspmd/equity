...
export const COMMUNITY_BUILDERS_IDS = [
  "reshma-saujani", // Code.org Founder (1975-)
  "michelle-williams", // Tech Community Organizer (-)
  "raquel-romualdo", // Tech Diversity Advocate (-)
  "stephanie-stewart", // Tech Inclusion Leader (-)
  "chloé-brown", // Data Science Community Builder (-)
] as const;
